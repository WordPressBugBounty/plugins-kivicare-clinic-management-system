...
class KCBase
{
	...
	public function KCGetRolesWithLabels()
	{
		return [
			'administrator' => __('Admin', 'kivicare-clinic-management-system'),
			$this->getClinicAdminRole() => __('Clinic Admin', 'kivicare-clinic-management-system'),
			$this->getDoctorRole() => __('Doctor', 'kivicare-clinic-management-system'),
			$this->getReceptionistRole() => __('Receptionist', 'kivicare-clinic-management-system'),
			$this->getPatientRole() => __('Patient', 'kivicare-clinic-management-system'),
		];
	}
	...
	public function getLoginUserRole()
	{
		...
		$kc_roles = array_intersect(
			array_merge(['administrator'], $this->KCGetRoles()),
			$user->roles
		);

		$this->loginUserRole = !empty($kc_roles) ? array_shift($kc_roles) : false;

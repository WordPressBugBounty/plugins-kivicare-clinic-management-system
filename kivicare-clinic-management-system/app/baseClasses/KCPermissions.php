...
class KCPermissions
{
    ...
    private static $role_capabilities = [
        KIVI_CARE_PREFIX . 'patient'    => [
            ...
            'followup_list'             => ['status' => 1],
            'followup_add'              => ['status' => 1],
            'followup_view'             => ['status' => 1],
            'followup_delete'           => ['status' => 1],
            'home_page'                 => ['status' => 1],
        ],
        KIVI_CARE_PREFIX . 'doctor' => [
            ...
            'followup_view'                     => ['status' => 1],
            'followup_delete'                   => ['status' => 1],
            'followup_cancel'                   => ['status' => 1],
            'chain_manage_clinical'             => ['status' => 1],
            'followup_create_clinical'          => ['status' => 1],
            'followup_update_clinical'          => ['status' => 1],
        ],
        KIVI_CARE_PREFIX . 'receptionist' => [
            ...
            'followup_view'                     => ['status' => 1],
            'followup_delete'                   => ['status' => 1],
            'chain_read_all'                    => ['status' => 1],
            'followup_schedule'                 => ['status' => 1],
            'followup_cancel'                   => ['status' => 1],
        ],

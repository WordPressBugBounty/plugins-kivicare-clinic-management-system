...
$data = [
    "common" => [
        ...
        "search_tax_data_global_placeholder" => __("Search by Name, Service Name, Tax Rate, Clinic Name, Doctor, Status", "kc-lang"),
        ...
        "search_bills_data_global_placeholder" => __("Search bills data by id,Encounter ID, clinic, doctor, patient, total amount, discount ,amount due  and status(0 or 1)", 'kc-lang'),
